...
class linear_layer:
    ...
    def forward(self, X):
        ...
        # print('b',self.params['b'])
        # print('dot',np.dot(X,self.params['W']))
        # print('addition',np.dot(X,self.params['W'])+self.params['b'])
    ...
    def backward(self, X, grad):
        ...
        # print('W.shape',self.gradient['W'].shape)
        # self.gradient['b'] = np.ones((1,self.gradient['W'].shape[1]))
        # print('b',self.gradient['b'].shape,self.gradient['b'])
        self.gradient['b'] = self.params['b']
        # print('b',self.gradient['b'].shape,self.gradient['b'])
